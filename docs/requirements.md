...
- FR-009: The CLI must validate that each service has either `image` or `build`.
- FR-010: The CLI must validate that build contexts referenced by Compose services exists.
